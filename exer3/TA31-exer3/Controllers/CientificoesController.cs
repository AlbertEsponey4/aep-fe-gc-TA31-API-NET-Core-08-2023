...
using Cientificos.Data;
using Cientificos.Models;

namespace TA31_exer3.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CientificoesController : ControllerBase
    {
        private readonly CientificosContext _context;

        public CientificoesController(CientificosContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Cientifico>> PostCientifico(Cientifico cientifico)
        {
          if (_context.Cientificos == null)
          {
              return Problem("Entity set 'CientificosContext.Cientificos'  is null.");
          }
